...
export default function DoctorMainList({navigation}) {
  ...
  return (
    <SafeAreaView>
        ...
        <Image
         ...
         <View style={{alignContent:'center',margin:27,justifyContent:'center',alignItems:'center'}}>
             <Text style={{fontFamily:'Times New Roman',fontSize:20,fontWeight:'bold'}} >Dr {name}</Text>
         </View>

         <TouchableOpacity onPress={()=>{
                 navigation.navigate('EditDoctorProfile',{_id})}}>
         <View style={{alignContent:'center',margin:27,justifyContent:'center',alignItems:'center'}}>
    ...
    <TouchableRipple onPress={()=>{navigation.navigate('Onboard1')}}>
            <View style={styles.menuItem}>
